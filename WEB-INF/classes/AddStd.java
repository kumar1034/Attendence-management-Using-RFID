...
public class AddStd extends Action
{
  String output;
    ...
    throws Exception
  {
	...
	String tag = regisForm.get("t12").toString();
	...
	if (isEmpty(tag))
      errors.add("t12", new ActionMessage("error.field.empty", "RFIDTag"));
	...
	if (errors.isEmpty()) {
        ...
        int i = DBCon.saveStudent(conn,name,fname,gender,year+"-"+month+"-"+day,qualification,designation,contact,mail,address,tag);
		if (i == 1){
