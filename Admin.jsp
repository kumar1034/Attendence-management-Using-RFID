...
<div id="wrapper">
   ...
   <h1 align="center"><bean:message key="adminloginform" /></h1><br/>
	...
	<br/>
	 <table align="center">
		  <tr><td><b><bean:message key="username" /></b></td><td><html:text name="AdminLoginForm" property="t1" styleId="t1"/></td></tr>
         <tr align="center"><td colspan="2" style="color:red"><html:errors property="t1"/></td></tr>

		  <tr><td><b><bean:message key="password" /></b></td><td><html:password name="AdminLoginForm" property="t2" styleId="t2"/></td></tr>
